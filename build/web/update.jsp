            ...
            <div id="page-wrapper">
                        ...
                        <div id="page-content">
                            ...
                            <div class="content-header">
                                <div class="header-section">
                                    <h1>
                                        <i class="gi gi-warning_sign"></i>Welcome Admin<br><small>You want to update event?</small>
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="block">
                                        ...
                                        <form id="form-validation" action="UpdateController" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_id" name="val_id" class="form-control" placeholder="Event Id.." readonly="" value="${requestScope.dto.eventID}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_name" name="val_name" class="form-control" placeholder="Event Name.." value="${requestScope.dto.eventName}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_size" name="val_size" class="form-control" placeholder="Event Size.." value="${requestScope.dto.size}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_location" name="val_location" class="form-control" placeholder="Event Location.." value="${requestScope.dto.location}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="masked_date3" name="masked_date3" class="form-control" value="${requestScope.dto.startEvent}">
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Event Banner <span class="text-danger">*</span></label>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="file" id="upload" name="upload" class="form-control" accept="image/*" enctype="multipart/form-data" />
                                                                <input type="hidden" name="hidden" value="${requestScope.dto.img}"/>
                                                                <span class="input-group-addon"><i class="fi fi-jpg"></i></span>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="checkhidden" value="No" id="checkhidden"/>
                                                        <img id="img" name="img" width="100" height="100" src="${requestScope.dto.img}"/>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-6">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea id="" name="val_description" rows="6" class="form-control ckeditor" placeholder="Tell us your story of event.." >${requestScope.dto.description}</textarea>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group form-actions">
                                                <div class="col-md-10 col-md-offset-5">
                                                    <button type="submit" class="btn btn-sm btn-primary" name="btnAction" value="Update Event"><i class="fa fa-arrow-right"></i> Update Event</button>
                ...
                <script>
                    function readURL(input) {
                        ...
                        document.getElementById("checkhidden").value = "Yes";
                    }
