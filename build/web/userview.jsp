                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-table"></i>Information <br><small>of All User</small>
                                </h1>
                                    ...
                                    <tbody>
                                        <Vinh:forEach items="${requestScope.list}" var="dto" varStatus="counter">
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="label label-info">${dto.email}</span></td>
                                                <td class="text-center">${dto.major}</td>
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="MainController?btnAction=DeleteUser&txtDelete=${dto.username}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                        <a href="UserPrizeController?username=${dto.username}" data-toggle="tooltip" title="Gift" class="btn btn-xs btn-danger"><i class="fa fa-gift"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </Vinh:forEach>
