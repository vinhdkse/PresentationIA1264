    ...
    return {
        init: function () {
            ...
            $('#form-reminder').validate({
                ...
                messages: {
                    'reminder-serect': 'Please provid a Secret Password',
                    'reminder-username': 'Please provid a Username',
                    'reminder-password': 'Please provid a Password'
                }
            });
            ...
            $('#form-register').validate({
                ...
                messages: {
                    ...
                    'register-terms': {
                        required: 'Please provide a serect password'
                    },
                    'register-username': {required: 'Please provide a username'}
