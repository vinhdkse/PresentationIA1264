                        ...
                        <div id="page-content">
                            ...
                            <div class="content-header">
                                <div class="header-section">
                                    <h1>
                                        <i class="gi gi-warning_sign"></i>Welcome Admin<br><small>You want to create new prize?</small>
                                    </h1>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="block">
                                        ...
                                        <div class="block-title">
                                            <h2><strong>Prize</strong> Create</h2>
                                        ...
                                        <form id="form-validation" action="MainController" method="post" class="form-horizontal form-bordered">
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_id" name="val_id" class="form-control" placeholder="Prize Id..">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_name" name="val_name" class="form-control" placeholder="Prize Name..">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_rank" name="val_rank" class="form-control" placeholder="Prize rank..">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_address" name="val_address" class="form-control" placeholder="Prize address..">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_quantity" name="val_quantity" class="form-control" placeholder="Quantity..">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea id="" name="val_description" rows="6" class="form-control ckeditor" placeholder="Tell us your story of prize.."></textarea>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group form-actions">
                                                <div class="col-md-10 col-md-offset-5">
                                                    <button type="submit" class="btn btn-sm btn-primary" name="btnAction" value="Create Prize"><i class="fa fa-arrow-right"></i> Create Prize</button>
