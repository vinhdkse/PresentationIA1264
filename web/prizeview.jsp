<%-- 
    Document   : eventview
    Created on : Oct 24, 2018, 4:35:46 PM
    Author     : vinhd
--%>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-table"></i>Information <br><small>of All Prize</small>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="block full">
                            <div class="block-title">
                                <h2><strong>Prize</strong>   View</h2>
                                ...
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">PrizeID</th>
                                            <th class="text-center">PrizeName</th>
                                    ...
                                    <tbody>
                                        <Vinh:forEach items="${requestScope.list}" var="dto" varStatus="counter">
                                            <tr>
                                                <td class="text-center">${counter.count}</td>
                                                <td class="text-center">${dto.prizeId}</td>
                                                <td class="text-center">${dto.prizeName}</td>
                                                <td class="text-center">${dto.rank}</td>
                                                <td class="text-center">${dto.quantity}</td>
                                                <td class="text-center">${dto.address}</td>
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="MainController?btnAction=EditPrize&prizeId=${dto.prizeId}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                        <a href="MainController?btnAction=DeletePrize&txtDelete=${dto.prizeId}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </Vinh:forEach>
