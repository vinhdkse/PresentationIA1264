                                        ...
                                        <Vinh:forEach items="${requestScope.list}" var="dto" varStatus="counter">
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="AddPrizeController?eventID=${requestScope.eventID}&prizeId=${dto.prizeId}" data-toggle="tooltip" title="Add" class="btn btn-xs btn-default"><i class="fa fa-plus-circle"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </Vinh:forEach>
