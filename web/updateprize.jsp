                        ...
                        <div id="page-content">
                            ...
                            <div class="content-header">
                                <div class="header-section">
                                    <h1>
                                        <i class="gi gi-warning_sign"></i>Welcome Admin<br><small>You want to update prize?</small>
                                    </h1>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="block">
                                        ...
                                        <div class="block-title">
                                            <h2><strong>Prize</strong> Update</h2>
                                            <h2 class="pull-right"><font color="red">${requestScope.VALID}</font></h2>
                                        </div>
                                        <!-- END Form Validation Example Title -->

                                        <!-- Form Validation Example Content -->
                                        <form id="form-validation" action="MainController" method="post" class="form-horizontal form-bordered">
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="val_id">Prize Id <span class="text-danger">*</span></label>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_id" name="val_id" class="form-control" placeholder="Prize Id.." value="${requestScope.dto.prizeId}"/>
                                                                <span class="input-group-addon"><i class="gi gi-fishes"></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="val_name">Prize Name <span class="text-danger">*</span></label>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_name" name="val_name" class="form-control" placeholder="Prize Name.." value="${requestScope.dto.prizeName}"/>
                                                                <span class="input-group-addon"><i class="gi gi-imac"></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="val_rank">Prize rank <span class="text-danger">*</span></label>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_rank" name="val_rank" class="form-control" placeholder="Prize rank.." value="${requestScope.dto.rank}"/>
                                                                <span class="input-group-addon"><i class="hi hi-sort-by-attributes-alt"></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="val_address">Prize address <span class="text-danger">*</span></label>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_address" name="val_address" class="form-control" placeholder="Prize address.." value="${requestScope.dto.address}"/>
                                                                <span class="input-group-addon"><i class="si si-readability"></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="val_quantity">Quantity <span class="text-danger">*</span></label>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="val_quantity" name="val_quantity" class="form-control" placeholder="Quantity.." value="${requestScope.dto.quantity}"/>
                                                                <span class="input-group-addon"><i class="gi gi-scuba_diving"></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea id="" name="val_description" rows="6" class="form-control ckeditor" placeholder="Tell us your story of prize..">${requestScope.dto.description}</textarea>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group form-actions">
                                                <div class="col-md-10 col-md-offset-5">
                                                    <button type="submit" class="btn btn-sm btn-primary" name="btnAction" value="Update Prize"><i class="fa fa-arrow-right"></i> Update Prize</button>
